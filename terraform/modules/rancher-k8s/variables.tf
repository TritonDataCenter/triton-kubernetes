...
variable "triton" {
  default     = false
  description = "Use triton machine driver to create Rancher hosts."
}
...
variable "azure" {
  default     = false
  description = "Use azure machine driver to create Rancher hosts."
}

variable "gcp" {
  default     = false
  description = "Use gcp machine driver to create Rancher hosts."
}
